...
create_generated_clock -name mig_clk  [get_pins {m1_nexys_a7_io_i/clk_wiz_0/inst/mmcm_adv_inst/CLKOUT2} ]
...
set_output_delay -clock [get_clocks sys_clock] -add_delay $untimed_od [get_ports dual_seven_seg_led_disp*]
set_output_delay -clock [get_clocks sys_clock] -add_delay $untimed_od [get_ports seven_seg_led_an*]
# Reset
...
//set_false_path -from [get_ports reset*] -to [get_clocks mig_clk]
