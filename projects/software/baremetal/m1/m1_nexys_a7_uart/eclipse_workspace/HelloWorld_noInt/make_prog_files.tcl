...
# Input files
set mmi_file            "../m1_nexys_uart_hw/hw/axi_bram_ctrl_0_bram.mmi"
set elf_file            "./Debug/HelloWorld_noInt.elf"
set source_bit_file     "../m1_nexys_uart_hw/hw/m1_uart_wrapper.bit"
set reference_bit_file  "../m1_nexys_uart_hw/hw/m1_uart_wrapper.bit"

# Output files
set output_bit_file "m1_nexys_HelloWorld_noInt_2.0.bit"
set output_mcs_file "m1_nexys_HelloWorld_noInt_2.0.mcs"
